...
# @Last Modified time: 2017-04-23 23:08:00
...
def load_rerank_data(input_file):
...
def generate_tensor_char_sep(structure_sentences, word_alphabet, char_alphabet,MAX_WORD_LENGTH,MAX_CHAR_LENGTH,case_sense=True, norm_digit=True, training=False):
	words_array = []
	chars_array = []
	label_array = []
...
if __name__ == '__main__':
	...
	train_file = "../data/train.rerank.filter-f"
	dev_file = "../data/dev.rerank.filter-f"
	test_file = "../data/test.rerank.filter-f"
	embed_file = None
